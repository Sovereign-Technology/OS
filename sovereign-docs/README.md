...
## Repository Architecture (v7.0+)

```
sovereign-os/
│
├── sovereign-kernel      ← FSM state machine, OS kernel, service worker
├── sovereign-sdk         ← Crypto primitives (security utils, Shamir SSS)
├── sovereign-identity    ← DID vault, W3C VCs, key recovery, onboarding
├── sovereign-canonical   ← DAO governance, proposals, voting, consensus
├── sovereign-evaluator   ← Adversarial security audit platform
├── sovereign-runtime     ← Transport layer, peer mesh, OS authority stack
├── sovereign-receipts    ← Transaction receipts and audit log
├── sovereign-explorer    ← Network search, relay hub, cross-chain bridge
├── sovereign-social      ← Messenger, layered mail, public square
├── sovereign-wallet      ← Self-custodial wallet, AI-governed payments
├── sovereign-ai          ← AI Studio — build, publish, monetize apps
├── sovereign-docs        ← This repo — canonical documentation
│
└── apps/
    ├── genesis           ← Genesis Node (index.html) — main entry point
    └── forge             ← Forge Platform — social, studio, marketplace hub
```

### Load Order

```
sovereign-sdk  →  sovereign-kernel  →  sovereign-runtime
    ↓                   ↓                    ↓
sovereign-identity  sovereign-canonical  sovereign-explorer
    ↓                   ↓                    ↓
sovereign-wallet  sovereign-receipts  sovereign-social
    ↓                   ↓
sovereign-ai    sovereign-evaluator
    ↓
  apps/*
```
